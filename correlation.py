...
correlation_results, _= run_seed_correlation_dataset(path_to_dataset = "/users2/local/alix/out",space = "MNI152NLin2009cAsym_res-2",subjects_to_include=subject_list,HMAT=HMAT, run_ids=[1], task_name= "NF")
...
display = plotting.plot_glass_brain(
        ...
        display_mode="lzr",
        plot_abs=False,
        title="[lPMC correlation] Group maps (p < 0.05 TFCE FWE)",
    )
display.add_contours(HMAT_full)
